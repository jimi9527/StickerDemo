...
public class DirectVideo {
    ...
    public DirectVideo(int texture) {
       ...
       //  int vertexShadercode = ShaderUtil.loadShader(GLES20.GL_VERTEX_SHADER,vertexShaderCode);
       //  int fragmentShadercode = ShaderUtil.loadShader(GLES20.GL_FRAGMENT_SHADER,fragmentShaderCode);
